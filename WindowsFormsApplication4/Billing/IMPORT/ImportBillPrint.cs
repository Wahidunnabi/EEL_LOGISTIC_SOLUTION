...
{
    public partial class ImportBillPrint : Form
    {
        ...
        public ImportBillPrint( UserInfo user)
        {
            InitializeComponent();
        ...
        private void ImportBillPrint_Load(object sender, EventArgs e)
        {
        ...
        private void PrepareGrid()
        {
            ...
            dataGridView1.Columns[1].HeaderText = "ImpInvoice Number";
            dataGridView1.Columns[1].DataPropertyName = "ImpInvoiceNumber";


            dataGridView1.Columns[2].Width = 90;
            dataGridView1.Columns[2].HeaderText = "Document status";
            dataGridView1.Columns[2].DataPropertyName = "DocumentsStatus";

            dataGridView1.Columns[3].Width = 90;
            dataGridView1.Columns[3].HeaderText = "BL Number";
            dataGridView1.Columns[3].DataPropertyName = "BLNo";

            dataGridView1.Columns[4].Width = 160;
            dataGridView1.Columns[4].HeaderText = "Importer Name";
            dataGridView1.Columns[4].DataPropertyName = "ImporterName";

            dataGridView1.Columns[5].Width = 70;
            dataGridView1.Columns[5].HeaderText = "MLO Code";
            dataGridView1.Columns[5].DataPropertyName = "CustomerCode";

           

            // dataGridView1.Columns[3].Width = 100;
            dataGridView1.Columns[6].HeaderText = "Total Amount";
            dataGridView1.Columns[6].DataPropertyName = "TotalAmount";

            //dataGridView1.Columns[4].Width = 100;
            dataGridView1.Columns[7].HeaderText = "VAT Amount";
            dataGridView1.Columns[7].DataPropertyName = "VATAmount";

                              
            //dataGridView1.Columns[5].Width = 120;
            dataGridView1.Columns[8].HeaderText = "Grand Total";
            dataGridView1.Columns[8].DataPropertyName = "GrandTotal";

            //dataGridView1.Columns[6].Width = 90;
            dataGridView1.Columns[9].HeaderText = "Upto Bill Date";
            dataGridView1.Columns[9].DataPropertyName = "Upto Date";

            //dataGridView1.Columns[7].Width = 90;
            dataGridView1.Columns[10].HeaderText = "Bill Date";
            dataGridView1.Columns[10].DataPropertyName = "Bill Date";

            dataGridView1.Columns[11].Visible = true;
            dataGridView1.Columns[11].HeaderText = "C&F Agents";
            dataGridView1.Columns[11].DataPropertyName = "CFAgentName";
        ...
        private void LoadDatatoGrid(int pageIndex)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("GetAllImportBill", con))
                {
        ...
        private void dataGridView1_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            //{
                int selectedrowindex = dataGridView1.SelectedCells[0].RowIndex;
                DataGridViewRow selectedRow = dataGridView1.Rows[selectedrowindex];
                var billId = Convert.ToInt32(selectedRow.Cells[12].Value);
        ...
        {
            var billId = Convert.ToInt32(selectedRow.Cells[12].Value);
            var ImpInvoice = Convert.ToString(selectedRow.Cells[1].Value).Trim();
            var docstatus = Convert.ToString(selectedRow.Cells[2].Value).Trim();
            var BLno = Convert.ToString(selectedRow.Cells[3].Value).Trim();
            var importer = Convert.ToString(selectedRow.Cells[4].Value).Trim();
            var MLO = Convert.ToString(selectedRow.Cells[5].Value).Trim();
            var CandF = Convert.ToString(selectedRow.Cells[11].Value).Trim();
            ...
            {               
                ...
                try
                {
                    ...
                    xlSummary.Range["A5:N5"].MergeCells = true;
                    xlSummary.Range["A5:N5"].Font.Underline = Excel.XlUnderlineStyle.xlUnderlineStyleSingle;


                    xlSummary.Cells[9, 7].value = "Documents Type:" + docstatus.ToUpper();
                    xlSummary.Cells[9, 8].Font.Bold = true;
                    xlSummary.Cells[9, 8].Font.Size = 10;
                    xlSummary.Cells[9, 8].HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                    xlSummary.Range["F9:k9"].MergeCells = true;
                    ...
                    xlSummary.Cells[r, 2].value = "B/L NO:";
                    ...
                    r = r + 2;
                    xlSummary.Cells[r, 2].value = "Invoice";
                    xlSummary.Cells[r, 3].value = ImpInvoice;
                    ...
                    {
                        string ImportOutdate = null;
                        string ImportIndate = null;
                        if (item.ImportIndate.Value != null)
                        {
                            ImportIndate = item.ImportIndate.Value.ToString("dd MMM yy");
                        }
                        else
                        { ImportIndate = string.Empty; }
                        if (item.ImportOutdate.Value != null)
                        {
                            ImportOutdate =  item.ImportOutdate.Value.ToString("dd MMM yy");
                        }
                        else
                        { ImportOutdate = string.Empty; }
                        xlSummary.Cells[r, 4].value = ImportIndate;
                        xlSummary.Cells[r, 5].value = ImportOutdate;
