...
namespace LOGISTIC.REPORT {
    ...
    public class InwarReport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "LOGISTIC.REPORT.InwarReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedInwarReport : Component, ICachedReport {
        
        public CachedInwarReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InwarReport rpt = new InwarReport();
            rpt.Site = this.Site;
            return rpt;
        }
